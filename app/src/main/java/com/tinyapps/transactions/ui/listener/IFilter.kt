...
import com.tinyapps.transactions.ui.state.AmountFilterState
 ...
 */
interface IFilter {
    fun fillerResults(amountState: AmountFilterState, tagState: TagFilterState, typeState: TypeFilterState)
    fun fillerCancel()
}